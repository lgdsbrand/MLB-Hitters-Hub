...
export default function Home() {
  ...
  return (
    <>
      {/* Top Banner - Horizontal Moving Ticker */}
      <TickerBanner
        games={games}
        hitsData={hitsData as Record<string, unknown>[]}
        hrData={hrData as Record<string, unknown>[]}
        tbData={tbData as Record<string, unknown>[]}
        loading={loading}
      />
